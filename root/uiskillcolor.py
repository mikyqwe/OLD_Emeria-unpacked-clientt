...
class SkillColorWindow(ui.ScriptWindow):
	...
	def __BindObject(self):
		...
		self.checkBox.SetParent(self.thinBoard)
		self.checkBox.SetPosition(-100, 22)
		...
		self.checkBox.SetCheckStatus(constInfo.IS_SKILLCOLOR_FLAG)
		self.checkBox.SetTextInfo("Color All")
		self.checkBox.Show()

	def SetColorAll(self, checkType, autoFlag):
		constInfo.IS_SKILLCOLOR_FLAG = autoFlag
	...
	def OnAcceptQuestionDialog(self, arg):
		if arg == 0:
			...
			if constInfo.IS_SKILLCOLOR_FLAG:
