...
class TargetBoard(ui.ThinBoard):
				...
				if race in constInfo.MONSTER_INFO_DATA:
					if len(constInfo.MONSTER_INFO_DATA[race]["items"]) == 0:
						...
						if len(constInfo.MONSTER_INFO_DATA[race]["items"]) > itemListBox.GetViewItemCount():
							itemScrollBar = ui.ScrollBarNewDesign()
							...
							#variable = float(height / (32 + 5))
							#if variable > 0:
								#itemScrollBar.SetMiddleBarSize(float(self.MAX_ITEM_COUNT) / variable)
							#else:
								#itemScrollBar.SetMiddleBarSize(10)
							itemScrollBar.Show()
	...
	def __init__(self):
		...
		closeButton.SetUpVisual("d:/ymir work/ui/pet/close_new/new1_normal.dds")
		closeButton.SetOverVisual("d:/ymir work/ui/pet/close_new/new2_hover.dds")
		closeButton.SetDownVisual("d:/ymir work/ui/pet/close_new/new3_down.dds")
		closeButton.SetPosition(39, 8)
		...
		if app.ENABLE_SEND_TARGET_INFO:
			...
			infoButton.SetUpVisual("d:/ymir work/dungeon_info_new/fragezeichen_normal.tga")
			infoButton.SetOverVisual("d:/ymir work/dungeon_info_new/fragezeichen_hover.tga")
			infoButton.SetDownVisual("d:/ymir work/dungeon_info_new/fragezeichen_down.tga")
		...
		self.buttonDict["PvP Menu"].SetEvent(ui.__mem_func__(self.OnPVPMenu))
