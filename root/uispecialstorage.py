...
class SpecialStorageWindow(ui.ScriptWindow):
	...
	WINDOW_NAMES = {
		UPGRADE_TYPE	:	uiScriptLocale.SPECIAL_STORAGE_UPGRADE_TITLE,
		BOOK_TYPE	:	uiScriptLocale.SPECIAL_STORAGE_BOOK_TITLE,
		STONE_TYPE	:	uiScriptLocale.SPECIAL_STORAGE_STONE_TITLE
	}
			...
			if app.SELL == curCursorNum:
				...
				if shop.IsOpen():
					if not shop.IsPrivateShop():
						net.SendShopSellPacketNew(itemSlotIndex, player.GetItemCount(self.SLOT_WINDOW_TYPE[self.categoryPageIndex]["window"], itemSlotIndex), self.SLOT_WINDOW_TYPE[self.categoryPageIndex]["window"])
