...
window = {
	...
	(
		{
			"name" : "Background", "type" : "board",  "style" : ("attach",), "x" : 175, "y" : 10, "width" : 200, "height" : 1,	
			"children" :
			(
			...
			(
				...
				{ "name" : "line2", "type" : "line", "x" : 369, "y" : 30, "width" : 0, "height" : 240, "color" : 0xffffffff, },
				{
					...
					(
						...
						#},
						{
							"name" : "LevelCharacter", "type" : "text", "x" : ELEMENTS_POS_X-ELEMENTS_POS_X, "y" : ELEMENTS_POS_Y+30, "text" : localeInfo.DUEL_INFO_3, "children" : (
