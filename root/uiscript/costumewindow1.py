...
window = {
	...
	"x" : SCREEN_WIDTH - 175 - 140 - 50,
	"y" : SCREEN_HEIGHT - 60 - 560,
					...
					(

						{
							...
							"slot" : (
										...
										{"index":COSTUME_START_INDEX+2, "x":62, "y":125, "width":32, "height":32},
										{"index":COSTUME_START_INDEX+3, "x":12, "y":125, "width":32, "height":32},
										{"index":COSTUME_START_INDEX+4, "x":12, "y":12, "width":32, "height":32},
							),
						},
					),
				},
