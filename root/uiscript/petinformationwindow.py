...
TITLEBAR_X = 8
TITLEBAR_Y = 7
TITLEBAR_WIDTH = PET_UI_BG_WIDTH - 15
	...
	(
		{
			...
			(
				...
				## Page Area INFOPAGE
				{
					...
					[
						## Pet UI BG
						{ "name" : "PetUIBG", "type" : "expanded_image", "style" : ("attach",), "x" : 0, "y" : 0, "image" : "d:/ymir work/ui/pet/res/pet_ui_bg.tga" },
						
						## Pet Feed Title
						{
							"name" : "TitleBar_InfoPage",
							"type" : "titlebar",
							"style" : ("attach",),
							...
							"children" :
							(
								{ "name":"TitleName", "type":"text", "x":-9, "y":-9, "text": uiScriptLocale.PET_FEED_TITLE, "all_align":"center" },
							),
						},
						...
						
						{
							...
							"default_image" : PET_UI_ROOT + "determine_button/determine_button_default.tga",
							"over_image" : PET_UI_ROOT + "determine_button/determine_button_hover.tga",
							"down_image" : PET_UI_ROOT + "determine_button/determine_button_down.tga",
						},
						...
						{ 
							...
							"children" :
							(
								{"name":"EvolName", "type":"text", "x":0, "y":0, "text": "Lv. 3 (Special Evolution)", "r":1.0, "g":0.85, "b":0.0, "a":1.0, "all_align" : "center"},
							),	
						},
						...
						{ 
							...
							"children" :
							(
								{"name":"AbilitiesName", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_INFORMATION_ABILITIES, "r":1.0, "g":0.85, "b":0.0, "a":1.0, "all_align" : "center"},
							),	
						},
						...
						## Attack Title
						{ 
							"name" : "AttWindow", "type" : "window", "x" : 20, "y" : 304, "width" : MIDDLE_LABLE_WIDTH, "height" : MIDDLE_LABLE_HEIGHT, "style" : ("attach",),
							"children" :
							(
								{"name":"AttTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_INFORMATION_ATT, "color":GOLD_COLOR, "all_align" : "center"},
							),
						},
						## Attack Value
						{ 
							"name" : "AttValueWindow", "type" : "window", "x" : 20 + MIDDLE_LABLE_WIDTH, "y" : 304, "width" : MIDDLE_LABLE_WIDTH, "height" : MIDDLE_LABLE_HEIGHT, "style" : ("attach",),
							"children" :
							(
								{"name":"AttValue", "type":"text", "x":0, "y":0, "text": "", "color":WHITE_COLOR, "all_align" : "center"},
							),
						},

						## Defence Title
						{ 
							"name" : "DefWindow", "type" : "window", "x" : 20, "y" : 326, "width" : MIDDLE_LABLE_WIDTH, "height" : MIDDLE_LABLE_HEIGHT, "style" : ("attach",),
							"children" :
							(
						...
						## Defence Value
						{ 
							"name" : "DefValueWindow", "type" : "window", "x" : 20 + MIDDLE_LABLE_WIDTH, "y" : 326, "width" : MIDDLE_LABLE_WIDTH, "height" : MIDDLE_LABLE_HEIGHT, "style" : ("attach",),
							"children" :
							(
						...
						{ 
							...
							"children" :
							(
								{"name":"PetSkillTitle", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_INFORMATION_SKILL, "r":1.0, "g":0.85, "b":0.0, "a":1.0, "all_align" : "center"},
							),
						},
				...
				## Page Area ATTR PAGE
				{
					...
					[
						...
						{ 
							...
							"children" :
							(
								{"name":"TitleName", "type":"text", "x":0, "y":0, "text": uiScriptLocale.PET_CHANGE_TEXT, "all_align" : "center"},
							),	
						},
						## Pet Feed Title
						{
							"name" : "TitleBar_AttrPage",
							"type" : "titlebar",
							"style" : ("attach",),
						...
						{ 
							"name" : "Pet_Determine_Info_Text", "type" : "window", "x" : 72, "y" : 316, "width" : 200, "height" : 11, "style" : ("attach",),
							"children" :
							(
