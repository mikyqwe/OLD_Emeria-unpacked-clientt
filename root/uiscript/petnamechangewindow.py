	...
	(
		{
			...
			(
				# Pet Name Change Window Title
				{
					...
					"children" :
					(
						{ "name":"TitleName", "type":"text", "x":0, "y": -7, "text":uiScriptLocale.PET_NAME_CHANGE_WINDOW_TITLE, "all_align":"center" },
					),
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"PetNamingTitle", "type":"text", "x":0, "y":-7, "text":uiScriptLocale.PET_HATCHING_NIK, "all_align" : "center"},
					),
				},
			),				
		},
