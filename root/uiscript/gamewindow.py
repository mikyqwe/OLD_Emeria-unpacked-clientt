...
window = {
	...
	(
		...
		{ 
			...
			"type" : "button", 
			"x" : SCREEN_WIDTH-50-32,
			"y" : SCREEN_HEIGHT-110,#100,
			"default_image" : "d:/ymir work/interface/button/skill_normal.tga",
			"over_image" : "d:/ymir work/interface/button/skill_hover.tga",
			"down_image" : "d:/ymir work/interface/button/skill_down.tga",
