...
class CubeRenewalWindows(ui.ScriptWindow):
	...
	def __init__(self):
		...
		self.categoria = [
			[1,"WEAPON","Weapons"],
			[2,"ARMOR","Armors"],
			[3,"TICKETS","Dungeon Tickets"],
			[4,"PVMARMOR","PvM Armor"],
			[5,"PVMWEAPON","PvM Weapons"],
			[6,"PVMSHIELD","PvM Shield"],
			[7,"BELT","Belts"],
			[8,"RINGS","Rings"],
			[9,"SHININGS","Shinings"],
			[10,"OTHER","Others"],
			[11,"BRACELETS","Bracelets"],
			[12,"NECKLACES","Necklaces"],
			[13,"EARRINGS","Earrings"],
			[14,"PETS","Pets"],
			[15,"MOUNTS","Mounts"],
			[16,"ORES","Ores"],
			[17,"SPRINGEVENT","Spring Event"],
			[18,"OTHEREVENTS","Other Events"],
			[19,"EASTEREVENT","Easter Events"],
			[20,"SUMMEREVENT","Summer Event Pets"],
			[21,"SUMMEREVENT2","Summer Event Mounts"],
			[22,"SUMMEREVENT3","Summer Event other Items"],
			[999,"ETC", "Etc"]
		]
