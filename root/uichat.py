...
class ChatLine(ui.EditLine):
	...
	CHAT_MODE_NAME = {	chat.CHAT_TYPE_TALKING : localeInfo.CHAT_NORMAL,
					...
					#	chat.CHAT_TYPE_SHOUT_TRADE : "Trade", 
					}
	...
	#	if app.GetTime() < self.lastShoutTime + 15:
	#		chat.AppendChat(chat.CHAT_TYPE_INFO, localeInfo.CHAT_SHOUT_TRADE_LIMIT)
	#		self.__ResetChat()
	#		return

	#	self.__SendChatPacket(text[1:], chat.CHAT_TYPE_SHOUT_TRADE)
	#	self.__ResetChat()
...
class ChatInputSet(ui.Window):
	...
	def __Create(self):
		...
		btnSend.SetUpVisual("d:/ymir work/interface/messenger/buttons/btn_guild_01_normal.tga")
		btnSend.SetOverVisual("d:/ymir work/interface/messenger/buttons/btn_guild_02_hover.tga")
		btnSend.SetDownVisual("d:/ymir work/interface/messenger/buttons/btn_guild_03_active.tga")
	...
	def RefreshPosition(self):
		...
		self.btnSend.SetPosition(self.GetWidth() - 30, -4)
...
class ChatWindow(ui.Window):
	...
	def __init__(self):
		...
		chatInputSet.SetSize(450, 25)
		self.chatInputSet = chatInputSet

		btnSendWhisper = ui.Button()
		btnSendWhisper.SetParent(self)
		btnSendWhisper.SetUpVisual("d:/ymir work/interface/messenger/buttons/btn_add_01_normal.tga")
		btnSendWhisper.SetOverVisual("d:/ymir work/interface/messenger/buttons/btn_add_02_hover.tga")
		btnSendWhisper.SetDownVisual("d:/ymir work/interface/messenger/buttons/btn_add_03_active.tga")
		...
		btnChatLog.SetUpVisual("d:/ymir work/interface/messenger/buttons/btn_chat_01_normal.tga")
		btnChatLog.SetOverVisual("d:/ymir work/interface/messenger/buttons/btn_chat_02_hover.tga")
		btnChatLog.SetDownVisual("d:/ymir work/interface/messenger/buttons/btn_chat_03_active.tga")
		...
		imgChatBarLeft.LoadImage("d:/ymir work/interface/chat/chat_bar_left.tga")
		imgChatBarLeft.Show()
		...
		imgChatBarRight.LoadImage("d:/ymir work/interface/chat/chat_bar_right.tga")
		...
		imgChatBarMiddle.LoadImage("d:/ymir work/interface/chat/chat_bar_middle.tga")
	...
	def __RegisterChatColorDict(self):
		CHAT_COLOR_DICT = {
			...
			#chat.CHAT_TYPE_SHOUT_TRADE : colorInfo.CHAT_RGB_SHOUT_TRADE,
	...
	## Open & Close
	def OpenChat(self):
		self.SetSize(self.CHAT_WINDOW_WIDTH, 20)
		...
		chat.SetHeight(self.chatID, y - btnY - self.EDIT_LINE_HEIGHT + 80)
		...
		self.btnSendWhisper.SetPosition(self.GetWidth() - 55, -4)
		self.btnSendWhisper.Show()

		self.btnChatLog.SetPosition(self.GetWidth() - 30, -4)
...
class ChatLogWindow(ui.Window):
	...
	CHAT_LOG_WINDOW_MINIMUM_HEIGHT = 150
	...
	def __CreateWindow(self):
		...
		imgLeft.LoadImage("d:/ymir work/interface/chat/titlebar_left.tga")
		imgCenter.LoadImage("d:/ymir work/interface/chat/titlebar_center.tga")
		imgRight.LoadImage("d:/ymir work/interface/chat/titlebar_right.tga")
		...
		btnClose.SetUpVisual("d:/ymir work/interface/button/thinboard_close_01_normal.tga")
		btnClose.SetOverVisual("d:/ymir work/interface/button/thinboard_close_02_hover.tga")
		btnClose.SetDownVisual("d:/ymir work/interface/button/thinboard_close_01_active.tga")
	...
	def __CreateButton(self):
		...
		btnAll.SetUpVisual("d:/ymir work/ui/public/xlarge_thin_button_01.sub")
		btnAll.SetOverVisual("d:/ymir work/ui/public/xlarge_thin_button_02.sub")
		btnAll.SetDownVisual("d:/ymir work/ui/public/xlarge_thin_button_03.sub")
		...
		for name in self.CHAT_MODE_NAME:
			...
			btn.SetUpVisual("d:/ymir work/ui/public/xlarge_thin_button_01.sub")
			btn.SetOverVisual("d:/ymir work/ui/public/xlarge_thin_button_02.sub")
			btn.SetDownVisual("d:/ymir work/ui/public/xlarge_thin_button_03.sub")
			btn.SetText(name)
			btn.Show()
	...
	def SetSize(self, width, height):
		...
		self.scrollBar.SetPosition(width - 19, 30)
			
		self.scrollBar.SetScrollBarSize(height - 40 - 12)
