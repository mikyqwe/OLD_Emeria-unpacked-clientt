...
class PartyMenu(ui.ThinBoard):
	...
	def __CreateButtons(self):
		...
		self.buttonDict[localeInfo.PARTY_BREAK_UP].SetUpVisual("d:/ymir work/interface/party/gruppe_close_normal.tga")
		self.buttonDict[localeInfo.PARTY_BREAK_UP].SetOverVisual("d:/ymir work/interface/party/gruppe_close_hover.tga")
		self.buttonDict[localeInfo.PARTY_BREAK_UP].SetDownVisual("d:/ymir work/interface/party/gruppe_close_down.tga")

		self.buttonDict[localeInfo.PARTY_LEAVE].SetEvent(net.SendPartyExitPacket)
		self.buttonDict[localeInfo.PARTY_LEAVE].SetUpVisual("d:/ymir work/interface/party/gruppe_close_normal.tga")
		self.buttonDict[localeInfo.PARTY_LEAVE].SetOverVisual("d:/ymir work/interface/party/gruppe_close_hover.tga")
		self.buttonDict[localeInfo.PARTY_LEAVE].SetDownVisual("d:/ymir work/interface/party/gruppe_close_down.tga")
...
class PartyWindow(ui.Window):
	...
	def __CreatePartyMenuButton(self):
		...
		partyMenuButton.SetUpVisual("d:/ymir work/interface/party/party_menu_new/party_menu_normal.tga")
		partyMenuButton.SetOverVisual("d:/ymir work/interface/party/party_menu_new/party_menu_hover.tga")
		partyMenuButton.SetDownVisual("d:/ymir work/interface/party/party_menu_new/party_menu_down.tga")
	...
	def OnTogglePartyMenu(self):
		if self.partyMenu.IsShow():
			self.partyMenuButton.SetUpVisual("d:/ymir work/interface/party/party_menu_new/party_menu_normal.tga")
			self.partyMenuButton.SetOverVisual("d:/ymir work/interface/party/party_menu_new/party_menu_hover.tga")
			self.partyMenuButton.SetDownVisual("d:/ymir work/interface/party/party_menu_new/party_menu_down.tga")
			self.partyMenu.Hide()
		else:
			self.partyMenuButton.SetUpVisual("d:/ymir work/interface/party/party_menu_new/party_menu_3_normal.tga")
			self.partyMenuButton.SetOverVisual("d:/ymir work/interface/party/party_menu_new/party_menu_3_hover.tga")
			self.partyMenuButton.SetDownVisual("d:/ymir work/interface/party/party_menu_new/party_menu_3_down.tga")
			self.partyMenu.Show()
