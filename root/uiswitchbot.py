...
class SwitchbotItemTab(ui.ThinBoardCircle):
	...
	def __LoadItemTab(self):	
		...
		self.selectButton.SetUpVisual("d:/ymir work/ui/public/small_button_01.sub")
		self.selectButton.SetOverVisual("d:/ymir work/ui/public/small_button_02.sub")
		self.selectButton.SetDownVisual("d:/ymir work/ui/public/small_button_03.sub")
		self.selectButton.SetDisableVisual("d:/ymir work/ui/public/small_button_01.sub")
		...
		self.itemSlot.SetSlotBaseImage("d:/ymir work/slot_lager/slot.tga", 1.0, 1.0, 1.0, 1.0)
	...
	def OverInItem(self, overSlotPos):
		...
		self.tooltipItem.AddItemData(itemVnum, metinSlot, attrSlot, preview=0)	
...
class SwitchbotWindow(ui.BoardWithTitleBar):
	...
	def __Initialize(self):		
		...
		self.boardAnimation = ui.BoardAnimation(self)
	...
	def __LoadWindow(self):
		...
		for i in xrange(switchbot.ALTERNATIVE_COUNT):
			...
			alternativeButton.SetUpVisual("d:/ymir work/ui/public/small_button_01.sub")
			alternativeButton.SetOverVisual("d:/ymir work/ui/public/small_button_02.sub")
			alternativeButton.SetDownVisual("d:/ymir work/ui/public/small_button_03.sub")
			alternativeButton.SetDisableVisual("d:/ymir work/ui/public/small_button_01.sub")
		...
		self.startButton.SetUpVisual("d:/ymir work/offline_shop_deco_new/neuer_schop_button_normal.tga")
		self.startButton.SetOverVisual("d:/ymir work/offline_shop_deco_new/neuer_schop_button_hover.tga")
		self.startButton.SetDownVisual("d:/ymir work/offline_shop_deco_new/neuer_schop_button_down.tga")
		self.startButton.SetDisableVisual("d:/ymir work/offline_shop_deco_new/neuer_schop_button_normal.tga")
		...
		self.stopButton.SetUpVisual("d:/ymir work/offline_shop_deco_new/neuer_schop_button_normal.tga")
		self.stopButton.SetOverVisual("d:/ymir work/offline_shop_deco_new/neuer_schop_button_hover.tga")
		self.stopButton.SetDownVisual("d:/ymir work/offline_shop_deco_new/neuer_schop_button_down.tga")
		self.stopButton.SetDisableVisual("d:/ymir work/offline_shop_deco_new/neuer_schop_button_normal.tga")
	...
	def RefreshSwitchbotItem(self, slot):
		...
		import chat
		#chat.AppendChat(chat.CHAT_TYPE_INFO, "RefreshSwitchbotItem slot: %d" % (slot))
		if not itemTab:
			return
...
class ConfigurationWindow(ui.BoardWithTitleBar):
	...
	def __LoadWindow(self):
		...
		self.saveButton.SetDisableVisual("d:/ymir work/ui/public/large_button_01.sub")
