...
class PartyMenu(ui.ThinBoard):
	...
	def __CreateModeButtons(self):
		...
		self.modeTitle.SetPosition(0, -15)
		...
		'''
		#NEUE EXP
		even_parity = ui.RadioButton()
		even_parity.SetParent(self)
		even_parity.SetWindowHorizontalAlignCenter()
		even_parity.SetEvent(ui.__mem_func__(self.OnClickEXPDistributeParityEven))
		even_parity.SetUpVisual("d:/ymir work/ui/public/large_button_01.sub")
		even_parity.SetOverVisual("d:/ymir work/ui/public/large_button_02.sub")
		even_parity.SetDownVisual("d:/ymir work/ui/public/large_button_03.sub")
		even_parity.SetText(localeInfo.PARTY_EXP_DISTRIBUTION_MODE_PARITY_EVEN)
		even_parity.SetToolTipText(localeInfo.PARTY_EXP_DISTRIBUTION_MODE_PARITY_EVEN_TOOLTIP, 70)
		even_parity.Show()
		self.modeButtonList[player.PARTY_EXP_DISTRIBUTION_PARITY_EVEN] = even_parity
		'''
	...
	def __SetModeButton(self, mode):
		...
		self.oldDistributionMode = self.distributionMode
	...
	def OnClickEXPDistributeParityEven(self):		
		self.__SetModeButton(self.distributionMode)
		if self.isLeader:
			net.SendPartyParameterPacket(player.PARTY_EXP_DISTRIBUTION_PARITY_EVEN)
				
	def ResetPartyParameter(self):
		self.__SetModeButton(self.oldDistributionMode)
...
class PartyWindow(ui.Window):
	...
	def __CreatePartyMenu(self):
		partyMenu = PartyMenu()
		partyMenu.SetSize(106, 70 + 70 + 20) ###!!!!
		partyMenu.Hide()
