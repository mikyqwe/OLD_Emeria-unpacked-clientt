...
class SafeboxWindow(ui.ScriptWindow):
	...
	def __MakePageButton(self, pageCount):
		...
		for i in xrange(pageCount):
			...
			button.SetUpVisual("d:/ymir work/slot_lager/lager_normal.tga")
			button.SetOverVisual("d:/ymir work/slot_lager/lager_hover.tga")
			button.SetDownVisual("d:/ymir work/slot_lager/lager_down.tga")
	...
	def SetTableSize(self, size):
		...
		self.wndItem.SetSlotBaseImage("d:/ymir work/slot_lager/slot.png", 1.0, 1.0, 1.0, 1.0)
