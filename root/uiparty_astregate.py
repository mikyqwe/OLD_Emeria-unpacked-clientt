...
FACE_IMAGE_DICT = {
	playerSettingModule.RACE_WARRIOR_M	: "d:/ymir work/interface/party/face/icon_mwarrior.tga",
	playerSettingModule.RACE_WARRIOR_W	: "d:/ymir work/interface/party/face/icon_wwarrior.tga",
	playerSettingModule.RACE_ASSASSIN_M	: "d:/ymir work/interface/party/face/icon_mninja.tga",
	playerSettingModule.RACE_ASSASSIN_W	: "d:/ymir work/interface/party/face/icon_wninja.tga",
	playerSettingModule.RACE_SURA_M		: "d:/ymir work/interface/party/face/icon_msura.tga",
	playerSettingModule.RACE_SURA_W		: "d:/ymir work/interface/party/face/icon_wsura.tga",
	playerSettingModule.RACE_SHAMAN_M	: "d:/ymir work/interface/party/face/icon_mshaman.tga",
	playerSettingModule.RACE_SHAMAN_W	: "d:/ymir work/interface/party/face/icon_wshaman.tga",
}
...
class PartyMemberInfoBoard(ui.ScriptWindow):
	...
	MEMBER_BUTTON_PATH = "d:/ymir work/interface/party/affects/"
	MEMBER_BUTTON_IMAGE_FILE_NAME_DICT = {	player.PARTY_STATE_LEADER : "btn_admin",
											player.PARTY_STATE_ATTACKER : "btn_attacker",
											player.PARTY_STATE_BERSERKER : "btn_berserk",
											player.PARTY_STATE_TANKER : "btn_blocker",
											player.PARTY_STATE_DEFENDER : "btn_defender",
											player.PARTY_STATE_BUFFER : "btn_magican",
											player.PARTY_STATE_SKILL_MASTER : "btn_fighter",
											MEMBER_BUTTON_NORMAL : "btn_member",
											MEMBER_BUTTON_WARP : "party_skill_warp",
											MEMBER_BUTTON_EXPEL : "btn_kick", }
	...
	def __LoadBoard(self):
		...
		try:
			...
			self.Face = self.GetChild("FaceImage")
			self.EmptyFace = self.GetChild("Empty_Face")
	...
	def __CreateStateButton(self):
		for key, name in self.MEMBER_BUTTON_IMAGE_FILE_NAME_DICT.items():
			if key == player.PARTY_STATE_LEADER:
				continue
			button = ui.Button()
			button.SetUpVisual(self.MEMBER_BUTTON_PATH + name + "_01_normal.tga")
			button.SetOverVisual(self.MEMBER_BUTTON_PATH + name + "_02_hover.tga")
			button.SetDownVisual(self.MEMBER_BUTTON_PATH + name + "_03_active.tga")
			button.Hide()
	...
	def SetCharacterState(self, state):
		...
		self.stateButton.SetUpVisual(self.MEMBER_BUTTON_PATH + name + "_01_normal.tga")
		self.stateButton.SetOverVisual(self.MEMBER_BUTTON_PATH + name + "_02_hover.tga")
		self.stateButton.SetDownVisual(self.MEMBER_BUTTON_PATH + name + "_03_active.tga")
	...
	def Link(self):
		self.nameTextLine.SetPackedFontColor(0xfff8d090)
		self.gauge.Show()

	def Unlink(self):
		self.vid = None
		self.nameTextLine.SetPackedFontColor(0xffa08784)
		self.gauge.Hide()
		self.__HideAllAffects()
...
class PartyMenu(ui.Window):
	...
	def __CreateModeButtons(self):
		...
		level.SetUpVisual("d:/ymir work/interface/party/menu/party_exp_radio_btn_level_01_normal.tga")
		level.SetOverVisual("d:/ymir work/interface/party/menu/party_exp_radio_btn_level_02_hover.tga")
		level.SetDownVisual("d:/ymir work/interface/party/menu/party_exp_radio_btn_level_03_active.tga")
		...
		parity.SetUpVisual("d:/ymir work/interface/party/menu/party_exp_radio_btn_equal_01_normal.tga")
		parity.SetOverVisual("d:/ymir work/interface/party/menu/party_exp_radio_btn_equal_02_hover.tga")
		parity.SetDownVisual("d:/ymir work/interface/party/menu/party_exp_radio_btn_equal_03_active.tga")
	...
	def __CreateButtons(self):
		...
		self.buttonDict[localeInfo.PARTY_BREAK_UP].SetUpVisual("d:/ymir work/interface/party/menu/party_btn_leave_01_normal.tga")
		self.buttonDict[localeInfo.PARTY_BREAK_UP].SetOverVisual("d:/ymir work/interface/party/menu/party_btn_leave_02_hover.tga")
		self.buttonDict[localeInfo.PARTY_BREAK_UP].SetDownVisual("d:/ymir work/interface/party/menu/party_btn_leave_03_active.tga")

		self.buttonDict[localeInfo.PARTY_LEAVE].SetEvent(net.SendPartyExitPacket)
		self.buttonDict[localeInfo.PARTY_LEAVE].SetUpVisual("d:/ymir work/interface/party/menu/party_btn_leave_01_normal.tga")
		self.buttonDict[localeInfo.PARTY_LEAVE].SetOverVisual("d:/ymir work/interface/party/menu/party_btn_leave_02_hover.tga")
		self.buttonDict[localeInfo.PARTY_LEAVE].SetDownVisual("d:/ymir work/interface/party/menu/party_btn_leave_03_active.tga")
...
class PartyWindow(ui.Window):
	...
	def __CreatePartyMenuButton(self):
		...
		partyMenuButton.SetUpVisual("d:/ymir work/ui/public/middle_button_01.sub")
		partyMenuButton.SetOverVisual("d:/ymir work/ui/public/middle_button_02.sub")
		partyMenuButton.SetDownVisual("d:/ymir work/ui/public/middle_button_03.sub")
	...
	def __ArrangePartyMemberInfoBoard(self):
		...
		(x, y) = self.GetGlobalPosition()
		self.partyMenu.SetPosition(-40, y + newHeight - 183)
	...
	def OnTogglePartyMenu(self):
		if self.partyMenu.IsShow():
			self.partyMenuButton.SetUpVisual("d:/ymir work/ui/public/middle_button_01.sub")
			self.partyMenuButton.SetOverVisual("d:/ymir work/ui/public/middle_button_02.sub")
			self.partyMenuButton.SetDownVisual("d:/ymir work/ui/public/middle_button_03.sub")
			self.partyMenu.Hide()
		else:
			self.partyMenuButton.SetUpVisual("d:/ymir work/ui/public/middle_button_01.sub")
			self.partyMenuButton.SetOverVisual("d:/ymir work/ui/public/middle_button_02.sub")
