...
class ShopDialogCreate(ui.ScriptWindow):
	...
	def __LoadQuestionDialog(self):
		...
		if POSITION_FIX:
			...
			self.UI["board"].SetSize(240, 260)
		self.UI["board"].SetCenterPosition()
		self.UI["board"].SetTop()
		self.UI["board"].SetTitleName(uiScriptLocale.SHOP_WINDOW_CREATE)
		self.UI["board"].Hide()
		
		self.UI["nameText"] = ui.MakeText(self.UI["board"], uiScriptLocale.SHOP_NAME, 95, 50, None)
		self.UI["nameEdit"]=Edit2(self.UI["board"],"",10,70,150,25,FALSE,6,30)
		
		
		self.UI["selectText"] = ui.TextLine()
		self.UI["selectText"].SetParent(self.UI["board"])
		self.UI["selectText"].SetPosition(15, 110)
		...
		self.UI["create"] = ui.MakeButton(self.UI["board"], 30, 140 , "", "d:/ymir work/ui/public/", "xlarge_button_01.sub", "xlarge_button_02.sub", "xlarge_button_03.sub")
		self.UI["create"].SetText(uiScriptLocale.SHOP_CREATE)
		self.UI["create"].SetEvent(ui.__mem_func__(self.CreateShop))
		self.UI["create"].Show()
		
		self.UI["open_decoration_info"] = ui.MakeButton(self.UI["board"], 30, 168 , "", "d:/ymir work/ui/public/", "xlarge_button_01.sub", "xlarge_button_02.sub", "xlarge_button_03.sub")
		self.UI["open_decoration_info"].SetText(uiScriptLocale.DEKO_MENU)
		self.UI["open_decoration_info"].SetEvent(ui.__mem_func__(self.OpenDecoInterfaces))
		self.UI["open_decoration_info"].Show()
		
		self.UI["cancel"] = ui.MakeButton(self.UI["board"], 30, 196 , "", "d:/ymir work/ui/public/", "xlarge_button_01.sub", "xlarge_button_02.sub", "xlarge_button_03.sub")
...
class ShopEditWindow(ui.ScriptWindow):
	...
	def OnSelectEmptySlot(self, selectedSlotPos):
		import sash
		import changelook
		if app.ENABLE_CHECK_IF_WINDOWS_OPEN:
			sash.Close()
			changelook.Close()
		...
		if isAttached:
			...
			priceInputBoard.SetMaxLength(15)
...
class ShopDialog(ui.ScriptWindow):
	...
	def Load(self,data):
		...
		#gui["nameTextImage"].SAFE_SetStringEvent("MOUSE_OVER_IN", lambda arg=data: self.__ShowToolTip(arg))
