...
class AffectShower(ui.Window):
	...
	AFFECT_DATA_DICT =	{
			...
			41 : ("Blessing from item buff", "d:/ymir work/ui/skill/shaman/hosin_03.sub",),
			42 : ("Dragon's Strength from item buff", "d:/ymir work/ui/skill/shaman/gicheon_03.sub",),		
			43 : ("Reflection from item buff", "d:/ymir work/ui/skill/shaman/boho_03.sub",),
	...
	if app.ENABLE_VIP_SYSTEM:
		AFFECT_DATA_DICT[chr.NEW_AFFECT_VIP] = (localeInfo.VIP_TOOLTIP, "icon/new/vip.tga")
	...
	if app.ENABLE_NEW_BLEND_AFFECT:
		...
		AFFECT_DATA_DICT[chr.AFFECT_BLEND_POTION_7] = (localeInfo.TOOLTIP_AFFECT_BLEND_POTION_7, "d:/ymir work/ui/game/blend_affect/" + str(chr.AFFECT_BLEND_POTION_7) + ".dds")
		AFFECT_DATA_DICT[chr.AFFECT_BLEND_POTION_8] = (localeInfo.TOOLTIP_AFFECT_BLEND_POTION_8, "d:/ymir work/ui/game/blend_affect/" + str(chr.AFFECT_BLEND_POTION_8) + ".dds")
		AFFECT_DATA_DICT[chr.AFFECT_BLEND_POTION_9] = (localeInfo.TOOLTIP_AFFECT_BLEND_POTION_9, "d:/ymir work/ui/game/blend_affect/" + str(chr.AFFECT_BLEND_POTION_9) + ".dds")
		AFFECT_DATA_DICT[chr.AFFECT_BLEND_POTION_10] = (localeInfo.TOOLTIP_AFFECT_BLEND_POTION_10, "d:/ymir work/ui/game/blend_affect/" + str(chr.AFFECT_BLEND_POTION_10) + ".dds")
		AFFECT_DATA_DICT[chr.AFFECT_BLEND_POTION_11] = (localeInfo.TOOLTIP_AFFECT_BLEND_POTION_11, "d:/ymir work/ui/game/blend_affect/" + str(chr.AFFECT_BLEND_POTION_11) + ".dds")
		AFFECT_DATA_DICT[chr.AFFECT_BLEND_POTION_12] = (localeInfo.TOOLTIP_AFFECT_BLEND_POTION_12, "d:/ymir work/ui/game/blend_affect/" + str(chr.AFFECT_BLEND_POTION_12) + ".dds")
		AFFECT_DATA_DICT[chr.AFFECT_BLEND_POTION_13] = (localeInfo.TOOLTIP_AFFECT_BLEND_POTION_13, "d:/ymir work/ui/game/blend_affect/" + str(chr.AFFECT_BLEND_POTION_13) + ".dds")
	...
	if app.ENABLE_NEW_PET_SYSTEM:
		AFFECT_PET_DATA_DICT ={
			5401 : (localeInfo.PET_SKILL_TOOLTIP_01 , "d:/ymir work/ui/skill/pet/01_resistance.sub"),
			5402 : (localeInfo.PET_SKILL_TOOLTIP_02 , "d:/ymir work/ui/skill/pet/01_resistance.sub"),
			5403 : (localeInfo.PET_SKILL_TOOLTIP_03 , "d:/ymir work/ui/skill/pet/01_resistance.sub"),
			5404 : (localeInfo.PET_SKILL_TOOLTIP_04 , "d:/ymir work/ui/skill/pet/01_resistance.sub"),
			5405 : (localeInfo.PET_SKILL_TOOLTIP_05 , "d:/ymir work/ui/skill/pet/01_resistance.sub"),
			5406 : (localeInfo.PET_SKILL_TOOLTIP_06 , "d:/ymir work/ui/skill/pet/06_beserk.sub"),
			5407 : (localeInfo.PET_SKILL_TOOLTIP_07 , "d:/ymir work/ui/skill/pet/07_anti_magic.sub"),
			5408 : (localeInfo.PET_SKILL_TOOLTIP_08 , "d:/ymir work/ui/skill/pet/08_haste.sub"),
			5409 : (localeInfo.PET_SKILL_TOOLTIP_09 , "d:/ymir work/ui/skill/pet/09_drill.sub"),
			5410 : (localeInfo.PET_SKILL_TOOLTIP_10 , "d:/ymir work/ui/skill/pet/10_restauration.sub"),
			5411 : (localeInfo.PET_SKILL_TOOLTIP_11 , "d:/ymir work/ui/skill/pet/11_stealhp.sub"),
			5412 : (localeInfo.PET_SKILL_TOOLTIP_12 , "d:/ymir work/ui/skill/pet/12_stealmp.sub"),
			5413 : (localeInfo.PET_SKILL_TOOLTIP_13 , "d:/ymir work/ui/skill/pet/13_block.sub"),
			5414 : (localeInfo.PET_SKILL_TOOLTIP_14 , "d:/ymir work/ui/skill/pet/14_reflection.sub"),
			5415 : (localeInfo.PET_SKILL_TOOLTIP_15 , "d:/ymir work/ui/skill/pet/15_gold_drop.sub"),
			5416 : (localeInfo.PET_SKILL_TOOLTIP_16 , "d:/ymir work/ui/skill/pet/16_bow_distance.sub"),
			5417 : (localeInfo.PET_SKILL_TOOLTIP_17 , "d:/ymir work/ui/skill/pet/17_immortal.sub"),
			5418 : (localeInfo.PET_SKILL_TOOLTIP_18 , "d:/ymir work/ui/skill/pet/18_panacea.sub"),
			5419 : (localeInfo.PET_SKILL_TOOLTIP_19 , "d:/ymir work/ui/skill/pet/19_potionbonus.sub"),
			5420 : (localeInfo.PET_SKILL_TOOLTIP_20 , "d:/ymir work/ui/skill/pet/20_mob_bonus.sub"),
			5421 : (localeInfo.PET_SKILL_TOOLTIP_21 , "d:/ymir work/ui/skill/pet/21_exp_bonus.sub"),
			5422 : (localeInfo.PET_SKILL_TOOLTIP_22 , "d:/ymir work/ui/skill/pet/22_hp_recover.sub"),
			5423 : (localeInfo.PET_SKILL_TOOLTIP_23 , "d:/ymir work/ui/skill/pet/23_feather.sub"),
		}
	...
	def BINARY_NEW_AddAffect(self, type, pointIdx, value, duration):
		...
		if app.ENABLE_NEW_BLEND_AFFECT:
			if type < 500 and\
				...
				not type == chr.AFFECT_BLEND_POTION_7 and\
				not type == chr.AFFECT_BLEND_POTION_8 and\
				not type == chr.AFFECT_BLEND_POTION_9 and\
				not type == chr.AFFECT_BLEND_POTION_10 and\
				not type == chr.AFFECT_BLEND_POTION_11 and\
				not type == chr.AFFECT_BLEND_POTION_12 and\
				not type == chr.AFFECT_BLEND_POTION_13 and\
				not type == chr.AFFECT_ENERGY:
				return
		else:
			if type < 500:
				return
		...
		if app.ENABLE_NEW_PET_SYSTEM:
			if affect >= 5400 and affect <= 5423:
